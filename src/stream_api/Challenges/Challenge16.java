...
public static void main(String[] args) {
    ...
    System.out.println("Lista com os números pares da lista original: " + numerosPares);
    System.out.println("Lista com os números ímpares da lista original: " + numerosImpares);
